  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <FieldSet>
          <FieldGroup>
            <Field>
              ...
              />
              {errors.fullName && (
                <p className="text-error text-xs">{errors.fullName.message}</p>
              )}
            </Field>
            <Field>
        ...
        <div className="flex flex-col gap-2">
          ...
          <Button
            ...
            variant="outline"
            onClick={() =>
              signIn("google", { callbackUrl: "/dashboard/invoices" })
            }
      ...
      <p className="text-center text-sm mt-6">
        ...
        <Link href="/auth/login" className="font-medium text-primary ml-1">
          Log In
        </Link>
      </p>
    </div>
